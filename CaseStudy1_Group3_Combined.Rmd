...
```{r}
beerDataOrig = read.csv("/Users/puri/DataScience@SMU/02.DS-6306 Doing Data Science/Case Study 1 - Final/Beers.csv",header = TRUE)
breweryDataOrig = read.csv("/Users/puri/DataScience@SMU/02.DS-6306 Doing Data Science/Case Study 1 - Final/Breweries.csv",header = TRUE)
```
